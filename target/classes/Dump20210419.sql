...
CREATE TABLE `item` (
  ...
  `type` varchar(30) NOT NULL DEFAULT 'SWITCH',
  PRIMARY KEY (`id`),
  UNIQUE KEY `iddocuments_UNIQUE` (`id`),
  UNIQUE KEY `name_UNIQUE` (`name`),
  UNIQUE KEY `item_topic_uindex` (`topic`)
...
INSERT INTO `item` VALUES (1,'Bedroom - light','-1','Light bedroom control','/bedroom/light/1',0,'DIMMER'),(2,'Bathroom - washer','-1','Washer bathroom control','/bathroom/washer/1',0,'SWITCH'),(3,'Hall - fresher','-1',NULL,'/hall/freshener/1',1,'SWITCH'),(4,'Hall - light','-1','Light hall control','/hall/light/1',50,'DIMMER'),(5,'Bathroom - water','-1','Water bathroom control','/bathroom/water/1',1,'SWITCH');
...
-- Dump completed on 2021-04-19 15:22:59
